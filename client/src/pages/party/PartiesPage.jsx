...
const PartiesPage = () => {
  ...
  return (
    <>
      <Flex align="center" justify="center" h={'full'} bg={'gray.900'}>
        <VStack>
              ...
              <Box w={'2xl'}>
                <Flex direction="column">
                  ...
                  <Text
                    ...
                    color={colorMode === 'light' ? 'white' : 'gray.800'}
                  >
                    Il semble qu'il n'y ait pas de parties en cours pour le
                    moment.
                  </Text>
                  <Text
                    fontSize="md"
                    ...
                    color={colorMode === 'light' ? 'white' : 'gray.800'}
                  >
                    Pourquoi ne pas créer une nouvelle partie ? Invitez vos amis
                    ou trouvez de nouveaux adversaires pour commencer à jouer
                    dès maintenant !
                  </Text>
                </Flex>
              </Box>
              ...
              <Box w={'2xl'}>
                <Flex direction="column">
                  ...
                  <Text
                    ...
                    color={colorMode === 'light' ? 'white' : 'gray.800'}
                  >
                    Vous trouverez ci-dessous la liste des parties en cours.
                    Rejoignez une partie pour commencer à jouer ou créez une
                    nouvelle partie pour défier des joueurs en liigne !
                  </Text>
                </Flex>
              </Box>
            </Center>
          ...
          <Center>
            <TableContainer
              borderRadius={10}
              w={gameInProgress.length > 0 ? 'full' : '2xl'}
            >
              <Table
                variant="simple"
                size="lg"
